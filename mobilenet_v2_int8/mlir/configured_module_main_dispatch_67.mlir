hal.executable public @main_dispatch_67 {
  hal.executable.variant public @embedded_elf_riscv_64 target(<"llvm-cpu", "embedded-elf-riscv_64", {cpu = "generic", cpu_features = "+m,+a,+d", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", native_vector_size = 16 : index, target_triple = "riscv64-unknown-unknown-eabi-elf", ukernels = "default"}>) {
    hal.executable.export public @main_dispatch_67_matmul_196x384x64_i8xi8xi32 ordinal(0) layout(#hal.pipeline.layout<push_constants = 0, sets = [<0, bindings = [<0, storage_buffer, ReadOnly>, <1, storage_buffer, ReadOnly>, <2, storage_buffer, ReadOnly>, <3, storage_buffer, ReadOnly>, <4, storage_buffer, ReadOnly>, <5, storage_buffer>]>]>) attributes {translation_info = #iree_codegen.translation_info<CPUDoubleTilingPeelingExpert>} {
    ^bb0(%arg0: !hal.device):
      %c1 = arith.constant 1 : index
      hal.return %c1, %c1, %c1 : index, index, index
    }
    builtin.module {
      func.func @main_dispatch_67_matmul_196x384x64_i8xi8xi32() {
        %c0_i32 = arith.constant 0 : i32
        %c6_i32 = arith.constant 6 : i32
        %c-6_i32 = arith.constant -6 : i32
        %c-2304_i32 = arith.constant -2304 : i32
        %c1624188629_i32 = arith.constant 1624188629 : i32
        ...
        ^bb0(%in: i32, %in_0: i32, %in_1: i32, %in_2: i32, %out: i8):
          ...
          %19 = arith.muli %in_2, %c-6_i32 : i32
          %20 = arith.subi %18, %19 : i32
          %21 = arith.addi %20, %c-2304_i32 : i32
          %22 = tosa.apply_scale %21, %c1624188629_i32, %c37_i8 {double_round = true} : (i32, i32, i8) -> i32
