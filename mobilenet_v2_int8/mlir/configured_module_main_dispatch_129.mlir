hal.executable public @main_dispatch_129 {
  hal.executable.variant public @embedded_elf_riscv_64 target(<"llvm-cpu", "embedded-elf-riscv_64", {cpu = "generic", cpu_features = "+m,+a,+d", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", native_vector_size = 16 : index, target_triple = "riscv64-unknown-unknown-eabi-elf", ukernels = "default"}>) {
    ...
    builtin.module {
      func.func @main_dispatch_129_matmul_49x160x960_i8xi8xi32() {
        ...
        %c1908224859_i32 = arith.constant 1908224859 : i32
        %c32_i8 = arith.constant 32 : i8
        %c11_i8 = arith.constant 11 : i8
        %c1733986385_i32 = arith.constant 1733986385 : i32
        ...
        ^bb0(%in: i32, %in_0: i32, %in_1: i32, %in_2: i32, %in_3: i8, %out: i8):
          ...
          %19 = arith.muli %in_1, %c3_i32 : i32
          %20 = arith.subi %18, %19 : i32
          %21 = arith.muli %in_2, %c-128_i32 : i32
          %22 = arith.subi %20, %21 : i32
          %23 = arith.addi %22, %c-368640_i32 : i32
          %24 = tosa.apply_scale %23, %c1409905126_i32, %c38_i8 {double_round = true} : (i32, i32, i8) -> i32
          %25 = arith.addi %24, %c5_i32 : i32
          ...
          %38 = tosa.apply_scale %37, %c1908224859_i32, %c32_i8 {double_round = true} : (i32, i32, i8) -> i32
          ...
          %51 = tosa.apply_scale %50, %c1733986385_i32, %c50_i8 {double_round = true} : (i32, i32, i8) -> i32
