hal.executable public @main_dispatch_87 {
  hal.executable.variant public @embedded_elf_riscv_64 target(<"llvm-cpu", "embedded-elf-riscv_64", {cpu = "generic", cpu_features = "+m,+a,+d", data_layout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128", native_vector_size = 16 : index, target_triple = "riscv64-unknown-unknown-eabi-elf", ukernels = "default"}>) {
    hal.executable.export public @main_dispatch_87_generic_1x14x14x384_i32xi32xi32xi32xi8 ordinal(0) layout(#hal.pipeline.layout<push_constants = 0, sets = [<0, bindings = [<0, storage_buffer, ReadOnly>, <1, storage_buffer, ReadOnly>, <2, storage_buffer, ReadOnly>, <3, storage_buffer, ReadOnly>, <4, storage_buffer>]>]>) attributes {translation_info = #iree_codegen.translation_info<CPUDoubleTilingExpert>} {
    ^bb0(%arg0: !hal.device):
      %c1 = arith.constant 1 : index
      hal.return %c1, %c1, %c1 : index, index, index
    }
    builtin.module {
      func.func @main_dispatch_87_generic_1x14x14x384_i32xi32xi32xi32xi8() {
        %c-128_i32 = arith.constant -128 : i32
        %c15_i32 = arith.constant 15 : i32
        %c-17280_i32 = arith.constant -17280 : i32
        %c2137714944_i32 = arith.constant 2137714944 : i32
        ...
        ^bb0(%in: i32, %in_0: i32, %in_1: i32, %in_2: i32, %out: i8):
          ...
          %17 = tosa.apply_scale %16, %c2137714944_i32, %c36_i8 {double_round = true} : (i32, i32, i8) -> i32
