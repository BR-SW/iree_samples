hal.executable public @main_dispatch_59 {
    ...
    builtin.module {
      func.func @main_dispatch_59_matmul_196x384x64_i8xi8xi32() {
        ...
        ^bb0(%in: i32, %in_0: i32, %in_1: i32, %in_2: i32, %out: i8):
          ...
          %21 = arith.addi %20, %c384_i32 : i32
          %22 = tosa.apply_scale %21, %c1682901674_i32, %c37_i8 {double_round = true} : (i32, i32, i8) -> i32
